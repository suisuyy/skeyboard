...
public class SpcBoard extends Keyboard {

    public  static int ASC2CODE_BACKSPACE=8;
    public  static int ASC2CODE_ESC=27;
    public  static int ASC2CODE_SHIFT=8;
    ...
    public SpcBoard(Context context, int xmlLayoutResId) {
        super(context, xmlLayoutResId);
    }

    public SpcBoard(Context context, int layoutTemplateResId, 
